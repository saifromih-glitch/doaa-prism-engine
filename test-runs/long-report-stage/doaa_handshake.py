...
def build(model_language: Any = "en") -> dict[str, Any]:
    ...
    message = {"protocol": PROTOCOL, "version": "1", "rules": [t["role"], *t["rules"]], "symbols": {"DOAA/1": "compact algorithmic request", "OK": "completed", "WAIT": "incomplete", "NO": "refused"}, "references": {"R1": "summarize faithfully; preserve facts; no tools", "R2": "compose a direct answer; no tools", "R3": "produce an ordered plan; do not execute steps"}, "response_contract": t["response"], "authority": "none", "automatic_execution": False}
