...
def build(proposal: Any, text: Any, request_id: str, language: str = "ar", literal_policy: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    request = {
        ...
        "context": {"algorithm_refs": [algorithm["id"]], "user_constraints": [], **({"literal_policy": literal_policy} if literal_policy is not None else {})},
