...
OUTPUT = Path("benchmark-data/arabicaqa/manus-warm-session-run.json")
...
doaa_system = "بروتوكول doaa.alg.v1. أجب عن كل عنصر q اعتماداً على ctx فقط. أخرج JSON مطابقاً للمخطط، بإجابة عربية موجزة لكل i، دون اختلاق."
