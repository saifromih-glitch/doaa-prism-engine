...
print(json.dumps({"tests":6,"status":"passed","xlsx_unicode_envelope":True,"commands_rejected":True,"code_rejected":True,"path_write_rejected":True,"automatic_execution":False}, ensure_ascii=False))
