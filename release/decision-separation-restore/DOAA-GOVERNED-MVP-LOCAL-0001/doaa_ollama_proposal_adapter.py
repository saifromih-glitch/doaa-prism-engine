...
def is_local_endpoint(endpoint):
    ...
    return parsed.scheme == "http" and parsed.hostname in {"127.0.0.1", "localhost"} and parsed.port is not None and parsed.path == "/api/generate" and not parsed.query and not parsed.fragment
